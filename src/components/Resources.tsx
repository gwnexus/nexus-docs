...
const resources: Array<Resource> = [
  {
    ...
    description:
      'Durable execution history for your project. Every agent action is logged and survives restarts.',
    icon: BookIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  },
  {
    ...
    name: 'ADR Workflow',
    description:
      'Draft, review, and accept Architecture Decision Records with a full audit trail.',
    icon: BoltIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  },
  {
    ...
    name: 'Knowledge Base',
    description:
      'Searchable project knowledge — sessions, decisions, research, and documents in one place.',
    icon: FolderIcon,
    pattern: {
      y: 32,
      squares: [
  ...
  },
  {
    ...
    description:
      'Reusable, versioned workflow instructions exposed to agents as slash commands.',
    icon: CogIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
...
export function Resources() {
  return (
    <div className="my-16 xl:max-w-none">
      <Heading level={2} id="core-concepts">
        Core concepts
      </Heading>

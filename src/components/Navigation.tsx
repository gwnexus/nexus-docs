...
export function Navigation(props: React.ComponentPropsWithoutRef<'nav'>) {
  return (
    <nav {...props}>
      <ul role="list">
        <TopLevelNavItem href="https://nexus.gatewarden.eu">App</TopLevelNavItem>
        <TopLevelNavItem href="https://github.com/gwnexus">GitHub</TopLevelNavItem>
        <TopLevelNavItem href="https://nexus.gatewarden.eu/dashboard/dispatches">Support</TopLevelNavItem>
        ...
        <li className="sticky bottom-0 z-10 mt-6 min-[416px]:hidden">
          <Button href="https://nexus.gatewarden.eu/login" variant="filled" className="w-full">
            Sign in
          </Button>
        </li>
      </ul>

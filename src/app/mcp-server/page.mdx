export const metadata = {
  ...
  description:
    'The nexus-mcp server is the specification layer between your AI agents and the Nexus knowledge platform. 62 tools for knowledge access, coordination, and governance.',
}
...
export const sections = [
  ...
  { title: 'Schema version envelope', id: 'schema-version-envelope' },
...
Published on npm as [`@gwdn/nexus-mcp`](https://www.npmjs.com/package/@gwdn/nexus-mcp). Current version: **v0.10.3**.

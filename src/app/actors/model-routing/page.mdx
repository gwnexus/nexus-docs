...
<Note>
  As of v0.13.2, the AI Gateway catalog is split into **Registry** (curated, routable models) and **Discover** (the full raw upstream feed). The Model Route catalog described below resolves against Registry entries only. See [AI Gateway](/ai-gateway) for the full model catalog and BYOK provider credentials.
</Note>
